...
-- Find the name, price, and rating of the most expensive app with a rating that’s less than 3.
    ...
    SELECT app_name,price,rating FROM analytics ORDER BY price DESC Limit 3;
...
-- Find the top 10 most-reviewed apps that cost between 10 cents and a dollar.
    ...
    SELECT app_name , price, reviews FROM analytics WHERE price >= 0.1 and price <= 1 ORDER BY reviews Desc LIMIT 10;
